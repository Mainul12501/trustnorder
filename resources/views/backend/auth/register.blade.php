                        ...
                        <form class="form-horizontal" action="{{ route('custom-register') }}" method="post">
                            ...
                            <div class="form-inputs">
                                <div class="form-floating mb-3">
                                    ...
                                    @error('name') <div class="text-danger">{{ $errors->first('name') }}</div> @enderror
                                </div>
                                {{--                            <div class="form-floating mb-3">--}}
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    @error('name') <div class="text-danger">{{ $errors->first('mobile') }}</div> @enderror
                                </div>
                                <div class="form-floating mb-3">
                                    ...
                                    @error('name') <div class="text-danger">{{ $errors->first('password') }}</div> @enderror
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="d-flex align-items-stretch">
                                    <button type="button" class="btn btn-info d-block w-100 send-otp">
                                        Sign up
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="otp-check d-none">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="user_otp" class="form-control form-input-bg" id="tb-rfnamex" placeholder="XXXX" required />
                                    <label for="tb-rfnamex">Enter OTP</label>
                                    <div class="invalid-feedback">OTP mismatched</div>
                                </div>
                                <div class="d-flex align-items-stretch">
